...
"""EXP-14: per-row vs global BitNet ternary on KAN, mnist_d64+orth_id."""
...
OUT = os.path.join(os.path.dirname(__file__), "results", "exp14_bitnet_row.json")
QUANTS = ["bitnet", "bitnet_row"]
SEEDS = list(range(5))
