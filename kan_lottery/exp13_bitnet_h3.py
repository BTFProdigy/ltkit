...
"""EXP-13 (H3 retest): BitNet absmean-ternary STE vs soft tanh quantizer on KAN, mnist_d64+orth_id."""
...
OUT = os.path.join(os.path.dirname(__file__), "results", "exp13_bitnet_h3.json")
QUANTS = ["soft", "bitnet"]
SEEDS = list(range(5))
